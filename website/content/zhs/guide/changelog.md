...
Sigilora Magic 是用于万智牌文本的彩色符号字体。它以全量字体族 `Sigilora Magic`（默认、阴影、扁平三种样式，通过 `ss01` / `ss02` 切换）和 Lite 字体族 `Sigilora Magic Lite`（仅默认样式）发布。当前版本覆盖 114 个符号——法术力、混血、非瑞、其他、特殊与忠诚计数器——采用 COLRv0。
